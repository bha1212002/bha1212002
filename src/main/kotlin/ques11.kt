...
fun main() {
    val firstMatrix = Matrix(arrayOf(intArrayOf(6, -1, 9), intArrayOf(7, 8, 5)), 2, 3)
    val secondMatrix1 = Matrix(arrayOf(intArrayOf(2, 6), intArrayOf(-1, 8), intArrayOf(0, 3)), 3, 2)
    val secondMatrix2 = Matrix(arrayOf(intArrayOf(3, 7), intArrayOf(2, 10), intArrayOf(4, 3)), 3, 2)
    println("-------Addition-------")
    println("Matrix 1 : ")
